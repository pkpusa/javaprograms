...
class Sale
{
    ...
    {   /*Displaying data for class Sale */
        ...
        System.out.println("\nDear "+stdName+" Here are the Details You Entered :\n\n");
        ...
        if(fines == true)
        {
            System.out.println("Repeat Exam         :   "+ "YES");
        }
        else
        {
            System.out.println("Repeat Exam         :   "+ "NO");
    ...
    public void dep()
    {
        if(yearofExam < 2000)
        {
            if(remarks<10 && remarks>=5)
            {
                if(rollNO != 0)
                {
                    System.out.println("\nCongrulations "+stdName+" you are Eligible For Exam ");
        ...
        {
            System.out.println("\nSorry ! "+stdName+" You are not eligible .");
        }
    }
    ...
    public void dep2()
    {
        if(yearofExam < 2000)
        {
            if(remarks<10 && remarks>=5)
            {
                if(rollNO != 0)
                {
                    System.out.println("\nCongrulatons "+stdName+" You  are Eligible for Exam");
                    System.out.println("\nEstimated Credits Earned");
                    float credits = (((attendance)*10)+(remarks*10));
                    System.out.println(""+ (credits/100));
                }
            }
        } 
        else
